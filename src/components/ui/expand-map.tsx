...
export function LocationMap({
    ...
    const handleClick = () => {
        if (isExpanded) {
            ...
            window.open('https://share.google/4u18bRScWPppgIJIu', '_blank')
        } else {
            // If collapsed, expand the map
            setIsExpanded(true)
        }
    }
    ...
    return (
        ...
        >
            ...
            >
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-gold-DEFAULT/10 via-transparent to-gold-DEFAULT/5" />
                ...
                <AnimatePresence>
                    {isExpanded && (
                        ...
                        >
                            ...
                            />
                            <motion.div
                                className="absolute top-[15%] left-[35%] w-[12%] h-[15%] rounded-sm bg-white/8 border border-white/8"
                                initial={{ opacity: 0, scale: 0.8 }}
                                animate={{ opacity: 1, scale: 1 }}
                                transition={{ duration: 0.4, delay: 0.6 }}
                            />
                            <motion.div
                                className="absolute top-[70%] left-[75%] w-[18%] h-[18%] rounded-sm bg-white/12 border border-white/12"
                                initial={{ opacity: 0, scale: 0.8 }}
                                animate={{ opacity: 1, scale: 1 }}
                                transition={{ duration: 0.4, delay: 0.7 }}
                            />
                            <motion.div
                                className="absolute top-[20%] right-[10%] w-[10%] h-[25%] rounded-sm bg-white/9 border border-white/9"
                                initial={{ opacity: 0, scale: 0.8 }}
                                animate={{ opacity: 1, scale: 1 }}
                                transition={{ duration: 0.4, delay: 0.55 }}
                            />
                            <motion.div
                                className="absolute top-[55%] left-[5%] w-[8%] h-[12%] rounded-sm bg-white/7 border border-white/7"
                                initial={{ opacity: 0, scale: 0.8 }}
                                animate={{ opacity: 1, scale: 1 }}
                                transition={{ duration: 0.4, delay: 0.65 }}
                            />
                            <motion.div
                                className="absolute top-[8%] left-[75%] w-[14%] h-[10%] rounded-sm bg-white/9 border border-white/9"
                                initial={{ opacity: 0, scale: 0.8 }}
                                animate={{ opacity: 1, scale: 1 }}
                ...
                <div className="relative z-10 h-full flex flex-col justify-between p-5">
                    ...
                    <div className="flex items-start justify-between">
                        ...
                        >
                            ...
                            <span className="text-[10px] font-medium text-gray-400 tracking-wide uppercase">HARİTADA GÖR</span>
                        </motion.div>
                    </div>
                    ...
                    <div className="space-y-1">
                        ...
                        {/* Animated underline */}
                        <motion.div
                            className="h-px bg-gradient-to-r from-gold-DEFAULT/50 via-gold-DEFAULT/30 to-transparent"
            ...
            <motion.p
                ...
                transition={{ duration: 0.2 }}
            >
                {isExpanded ? 'Google Haritalar\'da aç' : 'Haritayı görmek için tıklayın'}
            </motion.p>
        </motion.div>
    )
}
